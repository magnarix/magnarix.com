...
export const metadata: Metadata = {
  title: 'Use Cases — Enterprise Decision Governance in Practice',
  description:
    'Enterprise architecture decisions, transformation governance, risk and compliance, portfolio management, scenario planning, and institutional knowledge retention.',
}
...
export default function UseCasesPage() {
  return (
    <>
      <PageHero
        label="Use Cases"
        headline="Where decision memory reshapes organizational outcomes."
        subheadline="MagnaRix addresses the decision governance challenges that matter most in complex enterprise organizations — from architectural choices to regulatory compliance to strategic continuity."
        cta={{
      ...
      <CTASection
        headline="Which of these challenges resonates with your organization?"
        body="We welcome a direct conversation about where decision governance gaps are creating the most friction in your specific context."
